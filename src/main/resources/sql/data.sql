...
INSERT INTO users (name, surname, email, password, role)
VALUES ('Anatolii', 'K.', 'anatolii@gmail.com', '$2a$10$Y.E9czp4aJpNqZEEFIjIkeoFEeRzU2MaWdKJOdMGC/EqLOUXLR0dO',
        'CLIENT');

INSERT INTO users (name, surname, email, password, role)
VALUES ('Artem', 'Oh.', 'artem@gmail.com', '$2a$10$hTLBwMuzWuntQAFmZpS.XehvPmZsZ8AXkrg7p5VUzJAuFOmQPkbFa', 'ADMIN');

INSERT INTO users (name, surname, email, password, role)
VALUES ('Bohdan', 'K.', 'bohdan@gmail.com', '$2a$10$zK8Xg96lSKCQDNHyYrD.4.6ZAvKGVwd5fTeBwt8TtgcvugyJfZaYO', 'MASTER');

INSERT INTO users (name, surname, email, password, role)
VALUES ('Dmytro', 'Pr.', 'dmytro.pr@gmail.com', '$2a$10$r5ppYHLqbPQsjXMVo1iamuQwimQFUu2SbpY4WMq9C516zD.Zl6SM2',
        'CLIENT');
...
INSERT INTO users (name, surname, email, password, role)
VALUES ('Ihor', 'P.', 'ihor@gmail.com', '$2a$10$brExH5OxiQeakpXqMEzOHun.1BNa758CqXbIK.M4oNOu6TxBPUYwK', 'MASTER');
...
INSERT INTO users (name, surname, email, password, role)
VALUES ('Olena', 'P.', 'olena@gmail.com', '$2a$10$b.4.926FswtpbdNjgey9.uQ35OjvCL5GGjDgD6FRb53/5GdF6jUcG', 'MANAGER');
